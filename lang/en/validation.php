...
return [
    ...
    */
    ...
    'max' => [
        ...
        'numeric' => 'Цена не должна быть больше:max.',
    ...
    'password' => [
        ...
        'numbers' => 'Пароль должен содержать хотя бы одно число.',
        'symbols' => 'Пароль должен содержать хотя бы один символ.',
        'uncompromised' => 'Данный пароль появился в утечке данных. Пожалуйста, создайте другой пароль',
    ],
