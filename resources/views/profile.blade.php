...
@section('content')
        <form id="profile" class="flex flex-col md:px-40 bg-[#f9f9fa] px-6 mx-auto py-8" >
            <div  class="w-full bg-white rounded-lg bg-[#f9f9fa] md:mt-0 sm:max-w-md  ">
                ...
                <div class="space-y-4 md:space-y-6">
                    ...
                    <div>
                        ...
                        <input readonly type="text"  name="phone" id="phone" class="bg-gray-50 border-2 border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full p-2.5" value="{{ Auth::user()->phone}}">
                    </div>
                </div>
            </div>
