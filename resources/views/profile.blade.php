            ...
            <div  class="w-full bg-white rounded-lg  md:mt-0 sm:max-w-md  ">
                ...
                <div class="space-y-4 md:space-y-6">
                    <div>
                        ...
                        <input readonly type="text"  name="name" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full p-2.5" value="{{ Auth::user()->name }}">
                    </div>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Электронная почта</label>
                        <input readonly type="email"  name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full p-2.5" value="{{ Auth::user()->email }}">
                    </div>
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 ">Телефон</label>
                        <input readonly type="text"  name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full p-2.5" value="{{ Auth::user()->phone}}">
                    </div>
                </div>
            </div>
            @if (Auth::user()->id_role == 3)
                <div class="xl:w-3/5">
                    ...
                    <div class=" mb-3 ">
                        ...
                        <div class="mt-2">
                            <textarea readonly type="text" id="aboutCoach" name="about" class="h-24 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full " >{{ Auth::user()->coach_description}} </textarea>
                        </div>
                    </div>
                </div>
